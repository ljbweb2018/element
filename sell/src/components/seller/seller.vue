    ...
    <div class="seller-content">
      ...
      <div class="bulletin">
        ...
        <ul v-if="seller.supports" class="supports">
          <li class="support-item" v-for="(items, pro) in seller.supports" :key="(items.id,pro.id)">
            <span class="icon" :class="classMap[seller.supports[pro].type]"></span>
            <span class="text">{{ seller.supports[pro].description }}</span>
          </li>
        </ul>
      </div>
      <spilt></spilt>
      ...
      <div class="info">
        ...
        <ul>
          <li class="info-item" v-for="(info, infos) in seller.infos" :key="infos">{{info}}</li>
        </ul>
      </div>
    </div>
  </div>
